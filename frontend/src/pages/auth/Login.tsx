  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-3/5 relative overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1200&h=800&fit=crop&crop=entropy&auto=format&q=80"
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-16">
          ...
          >
            ...
            <p className="text-2xl text-white/90 mb-8 font-light leading-relaxed">
              Continue your journey with our premium marketplace experience.
            </p>
